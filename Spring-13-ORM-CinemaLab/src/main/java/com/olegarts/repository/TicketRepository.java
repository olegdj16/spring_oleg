...
import com.olegarts.entity.Ticket;
...
public interface TicketRepository extends JpaRepository<Ticket, Long> {
    ...
    Integer countAllByMovieCinema_MovieName(String name); // joining two tables
    ...
    @Query(value = "SELECT * FROM Ticket t WHERE t.userAccount.id = ?1", nativeQuery = true)
    ...
    @Query(value = "SELECT COUNT(*) FROM ticket WHERE user_account_id ", nativeQuery = true)
    ...
    Integer countTicketByUserNameInDateRange(@Param("userId") Long userId, @Param("dateTime1") LocalDateTime dateTime1, @Param("dateTime2") LocalDateTime dateTime2);
