...
import com.olegarts.entity.Region;
import com.olegarts.enums.Gender;
import com.olegarts.entity.Employee;
import com.olegarts.repository.DepartmentRepository;
...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Employee e4 = new Employee("Avrom", "Rowantree", null, LocalDate.of(2014, 04, 02), 119764, Gender.M);
